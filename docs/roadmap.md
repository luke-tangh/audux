...
v0.5 的核心工作流基线，以及 v0.6 的手动数据库备份与安全恢复、保存视图、智能
Playlist、资料库健康中心与安全重新关联已经完成。后续不再把“章节”“语义检索”
...
| v0.6 | Agent-ready 的可信内容基础 | 当前 | Transcript revision、证据锚点、质量 issue 和 Provider/工具边界稳定 |
| v0.7 | 有据检索与只读 Agent | 后续 | 限定范围问答可引用跳转，无范围泄漏，离线可退回 FTS |
