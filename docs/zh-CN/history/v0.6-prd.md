...
[历史资料](README.md) · [中文文档首页](../README.md) · [English](../../en/history/v0.6-prd.md) · 简体中文

> 本文件冻结记录 v0.6 规划时的需求、数据模型和阶段判断，不再代表当前实现或 API 契约。
> 当前 `1.0.0` 的产品边界以 [`项目路线图`](../project/roadmap.md)、
> [`数据、备份与安全`](../user-guide/data-and-security.md) 和当前代码/测试为准。不要依据本文的
