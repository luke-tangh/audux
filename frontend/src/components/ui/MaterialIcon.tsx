...
const ICON_PATHS = {
  ...
  download:
    "M11 3h2v10l3.5-3.5 1.4 1.4-5.9 5.9-5.9-5.9 1.4-1.4L11 13V3ZM5 19h14v2H5v-2Z",
  edit:
    "M3 17.3V21h3.7L17.6 10.1l-3.7-3.7L3 17.3Zm2.9 1.7H5v-.9l8.9-8.9.9.9L5.9 19ZM20.7 7c.4-.4.4-1 0-1.4l-2.3-2.3a1 1 0 0 0-1.4 0l-1.8 1.8 3.7 3.7L20.7 7Z",
  edit_note:
  ...
  filter_list:
    "M4 6h16v2H4V6Zm3 5h10v2H7v-2Zm3 5h4v2h-4v-2Z",
  menu_book:
  ...
  travel_explore:
    "M12 2a10 10 0 0 0 0 20c2.1 0 4.1-.7 5.7-1.8L22 24l2-2-3.8-3.8A10 10 0 0 0 12 2Zm6.9 8h-3.1a15.8 15.8 0 0 0-1.3-5A8.1 8.1 0 0 1 18.9 10ZM12 4c.8 1 1.5 3.1 1.8 6H10.2C10.5 7.1 11.2 5 12 4Zm-2.5 1A15.8 15.8 0 0 0 8.2 10H5.1A8.1 8.1 0 0 1 9.5 5ZM5.1 12h3.1c.1 2 .6 3.8 1.3 5A8 8 0 0 1 5.1 12Zm6.9 8c-.8-1-1.5-3.1-1.8-6h3.6c-.3 2.9-1 5-1.8 6Zm2.5-3c.7-1.2 1.2-3 1.3-5h3.1a8 8 0 0 1-4.4 5Z",
  verified:
    "m23 12-2.4-2.7.3-3.5-3.4-.8-1.8-3-3.2 1.4L9.3 1 7.5 4 4.1 4.8l.3 3.5L2 12l2.4 2.7-.3 3.5 3.4.8 1.8 3 3.2-1.4 3.2 1.4 1.8-3 3.4-.8-.3-3.5L23 12Zm-12.1 4.2-4-4 1.4-1.4 2.6 2.6 5-5 1.4 1.4-6.4 6.4Z",
  add_comment:
    "M4 4h16v13H7l-3 3V4Zm2 2v9.2L6.2 15H18V6H6Zm5 2h2v2h2v2h-2v2h-2v-2H9v-2h2V8Z",
  view_agenda:
